...
import com.stone.opengl.advanced3_heightmap.data.IndexBuffer;
import com.stone.opengl.advanced3_heightmap.data.VertexBuffer;
    ...
    private float[] loadBitmapData(Bitmap bitmap) {
        ...
        for (int row = 0; row < height; row++) {
            for (int col = 0; col < width; col++) {
                ...
                final float yPosition = (float)Color.red(pixels[(row * height) + col]) / (float)255; //灰度图，红色分量/255
