package com.stone.opengl.advanced5_livewallpaper.wallpaper;
...
import com.stone.opengl.advanced5_livewallpaper.WallpaperRenderer;
...
public class GLWallpaperService extends WallpaperService {
    ...
    public class GLEngine extends Engine {
        ...
        public void onCreate(SurfaceHolder surfaceHolder) {
            ...
            /*
            final ParticlesRenderer wallpaperRenderer =
                new ParticlesRenderer(GLWallpaperService.this);
            */
            wallpaperRenderer = new WallpaperRenderer(GLWallpaperService.this);
            ...
            if (supportsEs2) {
                ...
                glSurfaceView.setRenderer(wallpaperRenderer);
                rendererSet = true;
            } else {
                /*
        ...
        public void onOffsetsChanged(final float xOffset, final float yOffset,
            ...
            glSurfaceView.queueEvent(new Runnable() {
                @Override
                public void run() {
                    wallpaperRenderer.handleOffsetsChanged(xOffset, yOffset);
                }
            });
        }
        @Override
