 ...
 ***/
package com.stone.opengl.advanced5_livewallpaper;
...
import com.stone.opengl.advanced5_livewallpaper.object.HeightMap;
import com.stone.opengl.advanced5_livewallpaper.object.ParticleShooter;
import com.stone.opengl.advanced5_livewallpaper.object.ParticleSystem;
import com.stone.opengl.advanced5_livewallpaper.object.Skybox;
import com.stone.opengl.advanced5_livewallpaper.program.HeightmapShaderProgram;
import com.stone.opengl.advanced5_livewallpaper.program.ParticleShaderProgram;
import com.stone.opengl.advanced5_livewallpaper.program.SkyboxShaderProgram;
import com.stone.opengl.advanced5_livewallpaper.util.BitmapUtils;
import com.stone.opengl.advanced5_livewallpaper.util.Geometry;
import com.stone.opengl.advanced5_livewallpaper.util.LoggerConfig;
import com.stone.opengl.advanced5_livewallpaper.util.MatrixHelper;
import com.stone.opengl.advanced5_livewallpaper.util.TextureHelper;
    ...
    private void logFrameRate() {
        if (LoggerConfig.ON) {
            ...
            if (elapsedSeconds >= 1.0) {
                Log.v(getClass().getSimpleName(), frameCount / elapsedSeconds + "fps");
